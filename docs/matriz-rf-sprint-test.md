...
| RF-11 | Atención psicológica perfil integral | 5, 8, RF-11B | **Parcial / en avance** | Permiso `ver_perfil_psicologo_tutor` implementado en seeder (RF-11B) | Sin endpoint ni UI aún | `AlertaIntervencionTest` (parcial) | — | RF-11B base RBAC cerrada V1; backend/controller/frontend/tests/smoke manual pendientes. No es permiso clínico. Docente y directivo fuera de V1 |

...
| RF-06 | Procesamiento multivariable e índice de riesgo | 4, 8.5B | **RF-06D: cálculo enriquecido** | `POST …/procesar-riesgo`, `MlRiskService` | Perfil riesgo **en pausa** | `RiesgoTest` (38 passed) | Parcial | ML **determinístico**; RF-06D enriqueció payload con detalle académico, asistencia y conductual; pesos: académico 55%, asistencia 30%, conductual 15%; sin VSE/Fast Test; RF-06E pendiente |

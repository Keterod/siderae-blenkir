...
| RF-06 | Procesamiento multivariable e índice de riesgo | 4, 8.5B | **RF-06C: VSE/Fast Test retirados** | `POST …/procesar-riesgo`, `MlRiskService` | Perfil riesgo **en pausa** | `RiesgoTest` (20 passed) | Parcial | ML **determinístico**; RF-06C retiró VSE/Fast Test; mínimos: notas+asistencia; conducta opcional; pesos: 55/30/15; RF-06D pendiente |

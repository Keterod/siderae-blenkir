...
3. Marcar como **planificado**: RF-10, RF-18. **RF-04:** implementado V1 mínimo (Fase 2E). **RF-11:** **implementado V1** (RF-11B/C/D: permiso, backend, frontend); **smoke manual navegador pendiente**; Cypress no ejecutado. **RF-16:** **implementado V1** (backend + frontend + tests); smoke manual navegador pendiente. **RF-19:** implementado V1 (Fases 3B–3E); smoke manual navegador aprobado; Cypress no ejecutado. **RF-20:** **implementado V1** (Fases 4B–4E: RBAC, backend, frontend y cierre documental); **smoke manual navegador pendiente**; Cypress global no ejecutado.

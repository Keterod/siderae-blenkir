...
| RF-11 | Atención psicológica perfil integral | 5, 8, RF-11B–C | **Parcial / en avance** | Permiso `ver_perfil_psicologo_tutor` (RF-11B); endpoint `GET /api/psicologo-tutor/seguimiento` + controller + tests (RF-11C) | Sin UI aún | `AlertaIntervencionTest` (parcial); `PsicologoTutorSeguimientoTest` (RF-11C) | — | RF-11B/C cerradas V1; frontend RF-11D, cierre RF-11E y smoke manual pendientes. No es funcionalidad clínica. Docente y directivo fuera de V1 |

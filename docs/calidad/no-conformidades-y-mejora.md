...
| NC-02 | RF-01 importación **SIAGIE** pendiente | [`matriz-rf-sprint-test.md`](../matriz-rf-sprint-test.md), [`aula-notas-excel.md`](../aula-notas-excel.md), DRS v2 §RF-01 | Brecha funcional RF-01 | Alta | Mantener SIAGIE pendiente; no confundir con plantilla Excel | Product owner académico | Documentada en DRS v2 |
| NC-03 | ML **determinístico** vs DRS (RF/SVM/XGBoost) | [`limitaciones.md`](../limitaciones.md), DRS v2 §RF-06 | Expectativa ML avanzado no cumplida | Alta | RF-06 parcial documentado en DRS v2 | Equipo ML / doc | Documentada en DRS v2 |
| NC-04 | RF-18 reentrenamiento ML pendiente | [`matriz-rf-sprint-test.md`](../matriz-rf-sprint-test.md) | RF formal no implementado | Media | Backlog post-V1 | Equipo ML | Abierta |
...
| NC-12 | **VSE** pausada en UI (RF-05) | [`limitaciones.md`](../limitaciones.md), DRS v2 §RF-05 | RF-05 parcial visible | Media | Reactivar pestaña o mantener documentado | Producto | Documentada en DRS v2 |
| NC-13 | RF-10, RF-12, RF-19 pendientes | [`matriz-rf-sprint-test.md`](../matriz-rf-sprint-test.md), DRS v2 | Módulos DRS sin API | Alta | Backlog explícito en DRS v2 §2.3 | Documentación | Documentada en DRS v2 |
...
*Registro vivo — actualizar al cerrar brechas en Fase 7 o sprints posteriores.*

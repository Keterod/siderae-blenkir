...
| NC-11 | UI riesgo **en pausa**; sin botón procesar riesgo | [`manual-usuario.md`](../manual-usuario.md), `EstudiantePerfilRiesgo.jsx` | RF-06/20 parcial en UX | Media | RF-06E backend completo (61 tests, 210 assert.), Flask validado 5 escenarios. UI de procesamiento sigue en pausa — no hay botón en perfil estudiante. Procesar riesgo disponible vía API/comando técnico | Frontend + doc | **Parcial — backend RF-06E cerrado V1; UI pausa documentada** |

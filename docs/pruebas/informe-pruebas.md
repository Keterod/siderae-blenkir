...
| RF-11 seguimiento psicólogo/tutor | Sí (`PsicologoTutorSeguimientoTest`) | Sí | Confirmado RF-11C |
...
| D-10 | RF-10–12, RF-18 parcial; RF-04 con `ReporteConductualTest`; RF-19 con `SemaforoCompletitudTest`; RF-11C con `PsicologoTutorSeguimientoTest`; RF-20 con `HistorialRiesgoTest` | Media | Matriz §8; Fases 2E, 3C, RF-11C |

...
| Psicólogo perfil seguimiento | **Implementado V1** RF-11: base RBAC RF-11B + backend RF-11C + frontend RF-11D + cierre documental RF-11E implementados; smoke manual navegador pendiente; solo Chilca; no clínico |

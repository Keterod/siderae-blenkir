...
export default function Header({ email, etiquetaSesion, onLogout, onOpenNav }) {
  return (
    <header className="z-30 flex shrink-0 flex-wrap items-center gap-3 border-b border-[var(--border)] bg-[var(--surface)]/95 px-4 py-3 shadow-sm backdrop-blur-sm md:gap-5 md:px-6 md:py-3.5">
